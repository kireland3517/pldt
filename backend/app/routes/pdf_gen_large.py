...
def generate_large_pdf(
    ...
    if comps:
        ...
        c_tbl = Table(c_data, colWidths=[1.8*inch, 0.65*inch, 0.9*inch, 0.65*inch, 0.65*inch, 2.35*inch],
                      repeatRows=1)
    ...
    if active_listings:
        ...
        al_tbl = Table(al_data,
                       colWidths=[2.0*inch, 0.9*inch, 0.65*inch, 0.65*inch,
                                  0.65*inch, 0.55*inch, 0.6*inch],
                       repeatRows=1)
    ...
    if sales_history:
        ...
        story.append(Paragraph(
            ...
            _ps("lp_ctx", fontSize=14, leading=20, fontName=FBI,
